-- Complete analysis to run all sections of the assignment failure investigation
-- Run this entire script in Supabase SQL Editor to get comprehensive results
