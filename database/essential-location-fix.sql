-- Essential fixes for bi-directional location visibility
-- Run this in your Supabase SQL Editor

-- 1. Update existing functions to show last known locations
...
-- 2. Create the fallback function for users without location data
