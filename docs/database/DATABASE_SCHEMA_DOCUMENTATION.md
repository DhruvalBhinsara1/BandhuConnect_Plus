...
This document provides comprehensive documentation for the BandhuConnect+ PostgreSQL database schema, including tables, relationships, constraints, and security policies.
...
-- Request categories
CREATE TYPE request_type AS ENUM ('medical', 'emergency', 'lost person', 'sanitation', 'crowd management', 'guidance' , 'general help');
